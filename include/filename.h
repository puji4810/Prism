#ifndef PRISM_FILENAME_H_
#define PRISM_FILENAME_H_
...
namespace prism
{
	...
	// Return the name of the descriptor file for the db named by "dbname"
	// and the specified incarnation number. The result will be prefixed
	// with "dbname".
	...
	// If filename is a prism file, store the type of the file in *type.
	// The number encoded in the filename is stored in *number. If the
	// filename was successfully parsed, returns true. Otherwise returns false.
